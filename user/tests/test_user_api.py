...
class PublicUserApiTests(TestCase):
    ...
    def test_retrieve_user_unauthorized(self):
        ...
        #Проверяем что не авторизованный пользователь не сможет выполнить следующий запрос
...
class PrivateUserApiTests(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """Тест, что POST запрос не разрешен для URL-адреса ME"""
        res = self.client.post(ME_URL, {})

        self.assertEqual(res.status_code, status.HTTP_405_METHOD_NOT_ALLOWED)

    def test_update_user_profile(self):
        """Тестовое обновление профиля пользователя для аутентифицированного пользователя"""
